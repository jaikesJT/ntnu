...
aSirkel = math.pi*5.4**2
aSylinder = omkrets*hoyde+2*aSirkel
...
print("Areal av sirkelen:", aSirkel)
print("Areal av sylinderen:", aSylinder)
...
name = input('Name: ')
age = input('Age: ')
print('Jeg heter', name, 'og er', age, 'år.')
