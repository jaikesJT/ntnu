...
f1 = float(input("Skriv inn et flyttall: "))
...
print('Konvertert til flyttall blir det: ', float(i))
...
alder1 = int(input("Hei, " + navn + ", hvor gammel er du? "))
alder2 = int(input("Hvor gammel var du da du begynte å programmere? "))

print("Da har du programmert i ", alder1-alder2, " år.")

svar = input("Synes du de " + str(alder1-alder2) + " årene har vært givende? ")
...
f = float(input('Hva er tallet ditt?'))
print('Konvertert til heltall med int():', int(f))
print('Avrundet til nærmeste heltall:', round(f))
print('Avrundet til to desimaler:', round(f, 2))
print('Avrundet til fire desimaler:', round(f, 4))
print('Avrundet til nærmeste tusen:', int(round(f, -3)))
print("Heltall fra int() konvertert tilbake til flyttal:", float(int(f)))
...
f = float(input("Skriv inn et flyttall: "))
n = int(input("Hvor mange desimaler er ønskelig? "))
print("Tallet du skrev er", f, "og med", n, "desimaler blir det til", round(f, n))
